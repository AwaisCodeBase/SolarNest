export const en = {
  ...
  servicesPage: {
    ...
    services: [
      {
        name: "MEP (Mechanical, Electrical & Plumbing) Works",
        path: "mep",
      },
      {
      ...
      {
        name: "High Voltage Electrical Works",
        path: "electricity",
      },
      {
  ...
  team: {
    ...
    description: {
      paragraph1:
        "At Black Emerald, our strength lies in the diverse expertise, dedication, and experience of our multidisciplinary team. With a combined experience of over 20 years in Saudi Arabia, our professionals come from backgrounds in MEP engineering, civil construction, architecture, renewable energy, and high-voltage electrical systems.",
      paragraph2:
        "We are proud to work with engineers, project managers, planners, estimators, and technicians who have led and delivered high-profile projects across the Kingdom. Our leadership team includes industry veterans who have collaborated with major clients such as Saudi Electricity Company (SEC), ARAMCO, Royal Commission, and top-tier private developers. They bring deep knowledge of local regulations, procurement procedures, and technical standards.",
      paragraph3:
        "From conceptual design to project execution and post-completion support, every member of our team is committed to quality, innovation, and timely delivery. We foster a culture of collaboration, safety, and continuous learning, ensuring that our clients receive nothing short of excellence in every project we undertake.",
    },
    member1: {
      name: "John Doe",
    ...
    items: [
      {
        title: "Innovation",
        description:
          "We leverage the latest engineering and smart technology to provide cutting-edge solutions, ensuring that every project is efficient and future-proof.",
      },
      {
        title: "Sustainability",
        description:
          "Our projects are eco-friendly, energy-efficient, and aligned with global environmental standards, reducing carbon footprints and optimizing resource use.",
      },
      {
        title: "Excellence",
        description:
          "We uphold the highest industry standards in all our services, ensuring superior quality, reliability, and compliance with regulatory requirements.",
      },
      {
        title: "Integrity",
        description:
          "We work with government entities, private developers, and global industry leaders to deliver top-tier solutions that drive economic growth and development.",
      },
      {
        title: "Collaboration",
        description:
      ...
      },
      {
        title: "Safety First",
        description:
          "We prioritize the health, safety, and well-being of our team, clients, and the communities we serve—ensuring compliance with Saudi and international HSE standards.",
      },
    ],
  },
  home: {
