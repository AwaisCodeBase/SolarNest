...
const AnimatedStats = () => {
  ...
  return (
    <div className={`${styles.stats_section} ${isVisible ? styles.visible : ''}`}>
      <div className={styles.stats_container}>
        <div className={styles.stat_item}>
          <p className={styles.stat_label}>Experience</p>
          <p className={styles.stat_value}>{formatNumber(experienceCount)}</p>
        </div>
        <div className={styles.stat_item}>
          <p className={styles.stat_label}>Projects</p>
          <p className={styles.stat_value}>{formatNumber(projectsCount)}</p>
        </div>
        <div className={styles.stat_item}>
          <p className={styles.stat_label}>Clients</p>
